...
export default function ConversorTemperatura() {
  ...
  const [simboloTemperatura, setSimboloTemperatura] = useState("C");
	...
	C512,114.609,397.391,0,256,0z M256,472c-119.297,0-216-96.703-216-216S136.703,40,256,40s216,96.703,216,216S375.297,472,256,472z"
		...
		c4.358-4.203,7.922-9.25,10.547-15.234c2.734-5.906,4.047-12.5,4.047-19.625H284v256h-34.297V201.25z"
            ...
            <input
              ...
              onChange={(e) => setTemperatura(e.target.valueAsNumber)}
            />
          </div>
          <label className="block mt-3 text-sm font-medium text-gray-900 dark:text-white">
            Selecione para qual temperatura deseja converter
          </label>
          <div className="mt-2 grid grid-cols-2 gap-5">
            <button
              type="button"
              onClick={(e) => setSimboloTemperatura("C")}
            ...
            <button
              type="button"
              className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
              onClick={(e) => setSimboloTemperatura("F")}
            >
              ºF
            </button>
          </div>
